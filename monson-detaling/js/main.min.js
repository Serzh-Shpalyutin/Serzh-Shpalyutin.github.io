...
! function (e, t) {
    ...
    (b.fn.init = function (e, t, n) {
        ...
        if (n = n || N, "string" == typeof e) {
            ...
            if (r[1]) {
                if (t = t instanceof b ? t[0] : t, b.merge(this, b.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : v, !0)), j.test(r[1]) && b.isPlainObject(t))
    ...
    function U(e) {
        return e.replace(_, "ms-").replace(B, z)
    }
    var X = function (e) {
    ...
    function le(e, t) {
        for (var n, r, i = [], o = 0, a = e.length; o < a; o++)(r = e[o]).style && (n = r.style.display, t ? ("none" === n && (i[o] = V.get(r, "display") || null, i[o] || (r.style.display = "")), "" === r.style.display && oe(r) && (i[o] = ue(r))) : "none" !== n && (i[o] = "none", V.set(r, "display", n)));
    ...
    function Se(e, t, n) {
        n ? (V.set(e, t, !1), b.event.add(e, t, {
            namespace: !1,
            handler: function (e) {
                var r, o, a = V.get(this, t);
                if (1 & e.isTrigger && this[t]) {
                    if (a.length)(b.event.special[t] || {}).delegateType && e.stopPropagation();
                    else if (a = i.call(arguments), V.set(this, t, a), r = n(this, t), this[t](), a !== (o = V.get(this, t)) || r ? V.set(this, t, !1) : o = {}, a !== o) return e.stopImmediatePropagation(), e.preventDefault(), o && o.value
    ...
    b.event = {
        ...
        special: {
            ...
            click: {
                ...
                _default: function (e) {
                    var t = e.target;
                    return pe.test(t.type) && t.click && k(t, "input") && V.get(t, "click") || k(t, "a")
                }
            },
            beforeunload: {
    ...
    function Le(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            G.hasData(e) && (o = G.access(e), a = b.extend({}, o), G.set(t, a))
        }
    }
    ...
    function Oe(e, t, n, r) {
        ...
        var i, a, s, u, l, c, f = 0,
            ...
            v = t[0],
            m = h(v);
        if (m || p > 1 && "string" == typeof v && !d.checkClone && je.test(v)) return e.each((function (i) {
            var o = e.eq(i);
        ...
        if (p && (a = (i = xe(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === i.childNodes.length && (i = a), a || r)) {
            ...
            if (u)
                for (c = s[s.length - 1].ownerDocument, b.map(s, qe), f = 0; f < u; f++) l = s[f], he.test(l.type || "") && !V.access(l, "globalEval") && b.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? b._evalUrl && !l.noModule && b._evalUrl(l.src, {
    ...
    function Ue(e) {
        ...
        return t || (e in Be ? e : ze[e] = function (e) {
    ...
    b.extend({
        ...
        css: function (e, t, n, r) {
            var i, o, a, s = U(t);
            return Qe.test(t) || (t = Ue(s)), (a = b.cssHooks[t] || b.cssHooks[s]) && "get" in a && (i = a.get(e, !0, n)), void 0 === i && (i = $e(e, t, r)), "normal" === i && t in Ge && (i = Ge[t]), "" === n || n ? (o = parseFloat(i), !0 === n || isFinite(o) ? o || 0 : i) : i
        }
    }), b.each(["height", "width"], (function (e, t) {
        b.cssHooks[t] = {
            get: function (e, n, r) {
                if (n) return !Xe.test(b.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? Ke(e, t, r) : Ie(e, Ve, (function () {
                    return Ke(e, t, r)
                }))
            },
            set: function (e, n, r) {
                var i, o = Me(e),
                    ...
                    u = r ? Je(e, t, r, s, o) : 0;
                return s && a && (u -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(o[t]) - Je(e, t, "border", !1, o) - .5)), u && (i = ee.exec(n)) && "px" !== (i[3] || "px") && (e.style[t] = n, n = b.css(e, t)), Ye(0, n, u)
            }
        }
    ...
    b.Animation = b.extend(ut, {
            ...
            prefilters: [function (e, t, n) {
                ...
                for (r in n.queue || (null == (a = b._queueHooks(e, "fx")).unqueued && (a.unqueued = 0, s = a.empty.fire, a.empty.fire = function () {
                    ...
                    for (r in f && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (l = v && v.display) && (l = V.get(e, "display")), "none" === (c = b.css(e, "display")) && (l ? c = l : (le([e], !0), l = e.style.display || l, c = b.css(e, "display"), le([e]))), ("inline" === c || "inline-block" === c && null != l) && "none" === b.css(e, "float") && (u || (p.done((function () {
                            h.display = l
                        ...
                        for (r in g || le([e]), V.remove(e, "fxshow"), d) b.style(e, r, d[r])
    ...
    b.extend(b.event, {
        trigger: function (t, n, r, i) {
            ...
            if (a = d = s = r = r || v, 3 !== r.nodeType && 8 !== r.nodeType && !mt.test(y + b.event.triggered) && (y.indexOf(".") > -1 && (x = y.split("."), y = x.shift(), x.sort()), l = y.indexOf(":") < 0 && "on" + y, (t = t[b.expando] ? t : new b.Event(y, "object" == typeof t && t)).isTrigger = i ? 2 : 3, t.namespace = x.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + x.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : b.makeArray(n, [t]), p = b.event.special[y] || {}, i || !p.trigger || !1 !== p.trigger.apply(r, n))) {
                if (!i && !p.noBubble && !g(r)) {
                    for (u = p.delegateType || y, mt.test(u + y) || (a = a.parentNode); a; a = a.parentNode) m.push(a), s = a;
                    s === (r.ownerDocument || v) && m.push(s.defaultView || s.parentWindow || e)
                }
                for (o = 0;
                    (a = m[o++]) && !t.isPropagationStopped();) d = a, t.type = o > 1 ? u : p.bindType || y, (f = (V.get(a, "events") || Object.create(null))[t.type] && V.get(a, "handle")) && f.apply(a, n), (f = l && a[l]) && f.apply && X(a) && (t.result = f.apply(a, n), !1 === t.result && t.preventDefault());
    ...
    Rt.href = xt.href, b.extend({
        ...
        ajax: function (t, n) {
            ...
            for (f in (c = b.event && d.global) && 0 == b.active++ && b.event.trigger("ajaxStart"), d.type = d.type.toUpperCase(), d.hasContent = !qt.test(d.type), i = d.url.replace(At, ""), d.hasContent ? d.data && d.processData && 0 === (d.contentType || "").indexOf("application/x-www-form-urlencoded") && (d.data = d.data.replace(jt, "+")) : (p = d.url.slice(i.length), d.data && (d.processData || "string" == typeof d.data) && (i += (wt.test(i) ? "&" : "?") + d.data, delete d.data), !1 === d.cache && (i = i.replace(Nt, "$1"), p = (wt.test(i) ? "&" : "?") + "_=" + bt.guid++ + p), d.url = i + p), d.ifModified && (b.lastModified[i] && E.setRequestHeader("If-Modified-Since", b.lastModified[i]), b.etag[i] && E.setRequestHeader("If-None-Match", b.etag[i])), (d.data && d.hasContent && !1 !== d.contentType || n.contentType) && E.setRequestHeader("Content-Type", d.contentType), E.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + Pt + "; q=0.01" : "") : d.accepts["*"]), d.headers) E.setRequestHeader(f, d.headers[f]);
    ...
    b.ajaxSetup({
        ...
        return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (d.createHTMLDocument ? ((r = (t = v.implementation.createHTMLDocument("")).createElement("base")).href = v.location.href, t.head.appendChild(r)) : t = v), o = !n && [], (i = j.exec(e)) ? [t.createElement(i[1])] : (i = xe([e], t, o), o && o.length && b(o).remove(), b.merge([], i.childNodes)));
        var r, i, o
    }, b.fn.load = function (e, t, n) {
        var r, i, o, a = this,
            s = e.indexOf(" ");
        return s > -1 && (r = dt(e.slice(s)), e = e.slice(0, s)), h(t) ? (n = t, t = void 0) : t && "object" == typeof t && (i = "POST"), a.length > 0 && b.ajax({
            url: e,
            type: i || "GET",
            dataType: "html",
            data: t
    ...
    return b.noConflict = function (t) {
        return e.$ === b && (e.$ = Qt), t && e.jQuery === b && (e.jQuery = Xt), b
    }, void 0 === t && (e.jQuery = e.$ = b), b
})), $((function () {
    jQuery(document).ready((function () {
        var e = jQuery(".js-quiz-prev-btn"),
            t = jQuery(".js-quiz-next-btn"),
            n = jQuery(".compl_line").width(),
            r = jQuery(".steps_quiz .line").width() / 5;
        e.click((function () {
            var e = jQuery(".quiz__row-cont.active"),
                t = e.prev();
            e.removeClass("active"), e.removeClass("show"), t.addClass("active"), jQuery(".compl_line").css("width", "-=" + r);
            var n = $("#step_now").text();
            jQuery("#step_now").text(Number(n) - 1)
        })), t.click((function () {
            var e = jQuery(".quiz__row-cont.active"),
                t = e.next();
            e.removeClass("active"), e.removeClass("show"), t.addClass("active"), n < 569 && jQuery(".compl_line").css("width", "+=" + r);
            var i = jQuery("#step_now").text();
            jQuery("#step_now").text(Number(i) + 1)
        }))
    })), $(document).ready((function () {
        $(window).scroll((function () {
            $(window).scrollTop() >= 200 ? $("#masthead").addClass("scrolled") : $("#masthead").removeClass("scrolled")
        }))
    }));
    const e = document.querySelector(".mobile-btn"),
        t = document.querySelector(".menu"),
        n = document.querySelector(".toner");
    e.addEventListener("click", (function (r) {
        document.body.classList.toggle("lock"), e.classList.toggle("active"), t.classList.toggle("active"), n.classList.toggle("active")
    })), n.addEventListener("click", (function (r) {
        n.classList.remove("active"), document.body.classList.remove("lock"), e.classList.remove("active"), t.classList.remove("active")
    }))


    jQuery('.popup-toner, .close-popup').click(function () {
        jQuery('.popup').hide();
        jQuery('.popup-usl').hide();
        jQuery('.popup-toner').hide();
    });

    jQuery('.btn__obr-zvonok').click(function () {
        jQuery('#obr-zvnk').show();
        jQuery('.popup-toner').show();
    });

    jQuery('.usl-1').click(function () {
        jQuery('#usluga-1').show();
        jQuery('.popup-toner').show();
    });

    jQuery('.usl-2').click(function () {
        jQuery('#usluga-2').show();
        jQuery('.popup-toner').show();
    });

    jQuery('.usl-3').click(function () {
        jQuery('#usluga-3').show();
        jQuery('.popup-toner').show();
    });

    jQuery('.usl-4').click(function () {
        jQuery('#usluga-4').show();
        jQuery('.popup-toner').show();
    });

    jQuery('.usl-5').click(function () {
        jQuery('#usluga-5').show();
        jQuery('.popup-toner').show();
    });
